...
import 'package:tutor_app/screens/create_articles.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => CreateArticles())),
        child: Icon(
          Icons.add,
          color: Colors.white,
        ),
            ...
            Container(
              ...
              children: [
                ...
                FutureBuilder<DocumentSnapshot<Map<String, dynamic>>>(
                    future: FirebaseFirestore.instance.collection('tutor').doc(userId).get(),
      ...
      body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
          stream: FirebaseFirestore.instance.collection('article').where('userId', isEqualTo: userId).snapshots(),
          builder: (context, snapshot) {
            if (!snapshot.hasData) {
              ...
              if (snapshot.data.docs.length == 0) {
                ...
                articals = snapshot.data.docs.length.toString();
                          ...
                          child: ListTile(
                            ...
                            subtitle: Row(
                              children: [
                                ...
                                Text(
                                  DateFormat.yMMMMd('en_US').format(snapshot.data.docs[index].data()['createAt'].toDate()),
                                ),
                              ],
                            ),
                            trailing: Container(
