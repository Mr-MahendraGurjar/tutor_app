                  ...
                  if (_formKey.currentState.validate()) {
                    ...
                    try {
                      ...
                      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
                        firebaseRepository.tutorLogin(email: emailTextController.text, password: passwordTextController.text).then((value) async {
                  ...
                  children: [
                    ...
                    TextSpan(
                        ...
                        recognizer: TapGestureRecognizer()
                          ..onTap = () {
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>StudentSignUp(text: 'Tutor',type: '1',)));
                          }),
                  ],
                ),
              ),
